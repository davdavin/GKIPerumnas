        ...
        <section id="artikel" class="artikel section-bg">
            <div class="container">
                ...
                <div class="row  d-flex align-items-stretch">
                    <?php if (count($doa_harian) > 0) {
                        foreach ($doa_harian as $list) {
                    ?>
                        ...
                        <p class="tulisan-tengah"><?php echo "Belum Ada Bacaan Doa Harian"; ?></p>
                    <?php   } ?>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('.pilih-artikel').select2({
                ...
                ajax: {
                    url: '<?php echo base_url() . 'Artikel/cari_doa_harian' ?>',
                    type: 'POST',
                    dataType: 'JSON',
                    delay: 250,
