                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'Ruangan/list_peminjaman' ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Peminjaman</p>
                                    </a>
                                </li>
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="tabel_peminjaman" class="table table-bordered table-striped" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Ruangan</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tabel_peminjaman').DataTable({
                ...
                ajax: {
                    url: "<?php echo base_url() . 'Ruangan/tampil_peminjaman/' . $this->session->userdata('id') ?>",
                    dataSrc: ""
                },
                columns: [{
                        data: null,
