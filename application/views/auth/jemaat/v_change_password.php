...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/formlogin/vendor/css-hamburgers/hamburgers.min.css">
    ...
    <div class="limiter">
        ...
        <div class="container-login100" style="background-image: url('<?php echo base_url(); ?>resources/assets/img/slide/gedungbaruu.png');">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" method="post" action="<?php echo base_url() . 'jemaat/proses_change_password' ?>">
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="password" name="retype_password" placeholder="Konfirmasi Password" required>
                        <span class="focus-input100" data-placeholder="&#xe80f;"></span>
                    </div>
