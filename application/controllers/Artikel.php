...
class Artikel extends CI_Controller
{
    ...
    {
        if (!isset($_POST['searchTerm'])) {
            $renungan = $this->db->query("SELECT * FROM artikel WHERE status_artikel = 'DITERBITKAN' AND tipe_artikel = 'Renungan Harian'")->result_array();
        } else {
            $search = strtolower($_POST['searchTerm']);
            $renungan = $this->db->query("SELECT id_artikel, judul_artikel FROM artikel WHERE status_artikel = 'DITERBITKAN' AND tipe_artikel = 'Renungan Harian' AND judul_artikel LIKE '%$search%'")->result_array();
        }
    ...
    {
        if (!isset($_POST['searchTerm'])) {
            $renungan = $this->db->query("SELECT * FROM artikel WHERE status_artikel = 'DITERBITKAN' AND tipe_artikel = 'Doa Harian'")->result_array();
        } else {
            $search = strtolower($_POST['searchTerm']);
            $renungan = $this->db->query("SELECT id_artikel, judul_artikel FROM artikel WHERE status_artikel = 'DITERBITKAN' AND tipe_artikel = 'Doa Harian' AND judul_artikel LIKE '%$search%'")->result_array();
        }
    ...
    {
        if (!isset($_POST['searchTerm'])) {
            $renungan = $this->db->query("SELECT * FROM artikel WHERE status_artikel = 'DITERBITKAN' AND tipe_artikel = 'Warta Jemaat'")->result_array();
        } else {
            $search = strtolower($_POST['searchTerm']);
            $renungan = $this->db->query("SELECT id_artikel, judul_artikel FROM artikel WHERE status_artikel = 'DITERBITKAN' AND tipe_artikel = 'Warta Jemaat' AND judul_artikel LIKE '%$search%'")->result_array();
        }
    ...
    {
        if (!isset($_POST['searchTerm'])) {
            $renungan = $this->db->query("SELECT * FROM artikel WHERE status_artikel = 'DITERBITKAN' AND tipe_artikel = 'Artikel Lainnya'")->result_array();
        } else {
            $search = strtolower($_POST['searchTerm']);
            $renungan = $this->db->query("SELECT id_artikel, judul_artikel FROM artikel WHERE status_artikel = 'DITERBITKAN' AND tipe_artikel = 'Artikel Lainnya' AND judul_artikel LIKE '%$search%'")->result_array();
        }
