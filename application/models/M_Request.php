...
class M_Request extends CI_Model
{
    ...
    {
        return $this->db->query("SELECT nama_lengkap_anggota, nohp_baru, email_baru, alamat_baru, pekerjaan_baru, tanggal_kirim, waktu_kirim FROM permintaan_perubahan_data_jemaat 
