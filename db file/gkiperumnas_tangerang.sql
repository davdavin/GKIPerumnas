...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2022 at 09:28 AM
...
(8, 4, '00008', 'Joseph', 'joseph', '$2y$10$PyrYlxviw0nm92xesrnU9enzCEZffEud44QUxPLMfv6SSr.dhm6AC', 'Jl. Apel ', '0808273262314', 'contoh4@example.com', 'Laki-laki', 'A', 'AKTIF', 'S1', 'Karyawan', 'Sunda', 'Pengurus', '1996-02-09', '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', 1, '2021-11-10 16:00:00', '2022-12-16 12:31:50'),
...
(14, 4, '000014', 'Maria', 'maria', '$2y$10$HB01DdkDoYciXShzR8Ob/eaCCkx.EIHZyoQ5rVoedfO288R5H5Oly', 'Jl. Mangga', '088904040829', 'marmar@example.com', 'Perempuan', 'A', 'AKTIF', 'S1', 'Karyawan', 'Jawa', 'Jemaat', '1996-11-05', '2008-02-12', '0000-00-00', '2000-10-12', '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', 1, '2022-01-14 15:01:02', '2022-12-16 12:31:50'),
...
CREATE TABLE `detail_wilayah` (
  ...
  `id_wilayah` int(11) NOT NULL,
  `koordinator_wilayah` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(4, 4, 8, '2022-02-22 10:45:15', '2022-12-16 12:31:50'),
...
(1, 'Ibadah Umum', 300, '<ul>\r\n<li>Proyektor</li>\r\n<li>AC</li>\r\n<li>Perlengkapan Sound system</li>\r\n</ul>', 'ibadah-umum.jpg', 'AKTIF', '2022-09-08 14:59:55', '2022-12-16 11:29:36'),
(2, 'Majelis', 30, '<ul>\r\n<li>Proyektor</li>\r\n<li>TV</li>\r\n<li>AC</li>\r\n</ul>', 'majelis.jpg', 'AKTIF', '2022-09-08 15:00:02', '2022-11-05 12:34:29'),
(3, 'Aula', 40, '<ul>\r\n<li>2 Proyektor</li>\r\n<li>AC</li>\r\n<li>Perlengkapan sound system</li>\r\n</ul>', 'aula.jpg', 'AKTIF', '2022-09-08 15:00:06', NULL),
(4, 'Ruang Remaja', 30, '<ul>\r\n<li>Proyektor</li>\r\n<li>AC</li>\r\n<li>Papan tulis</li>\r\n</ul>', 'remaja.jpg', 'AKTIF', '2022-09-09 15:00:30', NULL),
(5, 'Ruang Dewasa', 30, '<ul>\r\n<li>TV</li>\r\n<li>AC</li>\r\n<li>Papan tulis</li>\r\n</ul>', 'dewasa.jpg', 'AKTIF', '2022-09-09 15:00:36', NULL);
...
INSERT INTO `user` (`id_user`, `id_level_user`, `id_anggota`, `id_pendeta`, `username`, `password`, `status_user`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, 'admin', '$2y$10$9KhGw19pT6w7zIjP2h/wD.zMBdQOU0GqqGb0i05wuJX4yvntK3TcG', 'AKTIF', '2022-09-18 20:18:08', '2022-10-11 09:01:06'),
(2, 2, 4, NULL, 'stella', '$2y$10$zWa0ie9.mG4qe98Ax2L9POR5eRm0orxzPgLQalCxdkd.tY035Cay6', 'AKTIF', '2022-09-18 20:13:20', '2022-10-22 21:25:28'),
(4, 3, NULL, 2, 'yohanes', '$2y$10$jpLepgnYa5lmDmSm3I2fWe7guZ55EmtDxM4vLiAxQjSQFFcutZVc6', 'AKTIF', '2022-09-19 21:27:47', '2022-11-07 22:17:42'),
(5, 2, 16, NULL, 'sekretariat', '$2y$10$rMmoMktv2U/oS9vqK7EpFu7f9/0Z14oAyrWMIOea/n1kwwJLi8K26', 'AKTIF', '2022-09-20 10:39:22', '2022-09-20 10:41:26'),
(6, 4, 6, NULL, 'markus', '$2y$10$SfzDnadVBTS4xmGtd15CruLdbqipmX/eEWi1NQ/O7/56J/evkdCky', 'AKTIF', '2022-10-15 11:09:39', NULL);
...
(4, 'Wilayah 4', 1, '2022-02-08 10:39:07', '2022-12-16 12:31:50'),
